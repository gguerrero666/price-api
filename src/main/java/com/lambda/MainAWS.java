...
public class MainAWS {
    ...
    public static void main(String[] args) {
        ...
        lista.add(new AwsData(19, "Developer Tools", "Amazon CodeCatalyst(Preview)", "Unified software development service for faster development and delivery on AWS"));
        ...
        lista.add(new AwsData(25, "Analytics", "Amazon DataZone(Preview)", "Unlock data across organizational boundaries with built-in governance"));
        ...
        lista.add(new AwsData(33, "Storage", "Amazon Elastic Block Store(EBS)", "EC2 block storage volumes"));
        lista.add(new AwsData(34, "Containers", "Amazon Elastic Container Registry(ECR)", "Easily store, manage, and deploy container images"));
        lista.add(new AwsData(35, "Containers", "Amazon Elastic Container Service(ECS)", "Highly secure, reliable, and scalable way to run containers"));
        lista.add(new AwsData(36, "Storage", "Amazon Elastic File System(EFS)", "Fully managed file system for EC2"));
        lista.add(new AwsData(37, "Machine Learning", "Amazon Elastic Inference", "Deep learning inference acceleration"));
        lista.add(new AwsData(38, "Containers", "Amazon Elastic Kubernetes Service(EKS)", "The most trusted way to run Kubernetes"));
        ...
        lista.add(new AwsData(54, "Databases", "Amazon Keyspaces(for Apache Cassandra)", "Managed Cassandra-compatible database"));
        ...
        lista.add(new AwsData(68, "Analytics", "Amazon Managed Streaming for Apache Kafka(MSK)", "Fully managed Apache Kafka service"));
        lista.add(new AwsData(69, "Application Integration", "Amazon Managed Workflows for Apache Airflow(MWAA)", "Highly available, secure, and managed workflow orchestration for Apache Airflow"));
        ...
        lista.add(new AwsData(80, "Blockchain", "Amazon Quantum Ledger Database(QLDB)", "Fully managed ledger database"));
        ...
        lista.add(new AwsData(85, "Networking & Content Delivery", "Amazon Route 53", "53 Scalable domain name system(DNS)"));
        ...
        lista.add(new AwsData(89, "Security, Identity & Compliance", "Amazon Security Lake(Preview)", "Automatically centralize your security data with a few clicks"));
        lista.add(new AwsData(90, "Front-End Web & Mobile", "Amazon Simple Email Service(SES)", "High-scale inbound and outbound email"));
        lista.add(new AwsData(91, "Application Integration", "Amazon Simple Notification Service(SNS)", "Pub/sub, SMS, email, and mobile push notifications"));
        lista.add(new AwsData(92, "Application Integration", "Amazon Simple Queue Service(SQS)", "Managed message queues"));
        lista.add(new AwsData(93, "Storage", "Amazon Simple Storage Service(S3)", "Object storage built to retrieve any amount of data from anywhere"));
        ...
        lista.add(new AwsData(99, "Security, Identity & Compliance", "Amazon Verified Permissions(Preview)", "Fine-grained permissions and authorization for your applications"));
        ...
        lista.add(new AwsData(105, "Migration", "AWS Application Migration Service(MGN)", "Automate application migration and modernization"));
        ...
        lista.add(new AwsData(110, "Serverless", "AWS Application Composer(Preview)", "Visually design and build serverless applications quickly"));
        ...
        lista.add(new AwsData(121, "Analytics", "AWS Clean Rooms(Preview)", "Match, analyze, and collaborate on datasets–without sharing or revealing underlying data"));
        ...
        lista.add(new AwsData(123, "Developer Tools", "AWS Cloud Development Kit(CDK)", "Model cloud infrastructure using code"));
        ...
        lista.add(new AwsData(136, "Developer Tools", "AWS Command Line Interface(CLI)", "Line Interface Unified tool to manage AWS services"));
        ...
        lista.add(new AwsData(145, "Migration", "AWS Database Migration Service(DMS)", "Migrate databases with minimal downtime"));
        ...
        lista.add(new AwsData(181, "Security, Identity & Compliance", "AWS Key Management Service(KMS)", "Managed creation and control of encryption keys"));
        ...
        lista.add(new AwsData(215, "Business Applications", "AWS Supply Chain(Preview)", "Mitigate risks and lower costs with an ML-powered supply chain application"));
        ...
        lista.add(new AwsData(221, "Networking & Content Delivery", "AWS Verified Access(Preview)", "Provide secure access to corporate applications without a VPN"));
        ...
        lista.add(new AwsData(228, "Storage", "AWS Elastic Disaster Recovery(DRS)", "Scalable, cost-effective application recovery to AWS"));
        lista.add(new AwsData(229, "Networking & Content Delivery", "Elastic Load Balancing(ELB)", "Distribute incoming traffic across multiple targets"));
        lista.add(new AwsData(230, "Internet Of Things", "FreeRTOS", "Real-time operating system for microcontrollers"));
        lista.add(new AwsData(231, "Migration", "Migration Evaluator(formerly TSO Logic)", "Create a business case for cloud migration"));
        ...
        lista.add(new AwsData(234, "Cloud Financial Management", "Reserved Instance(RI) Reporting", "Dive deeper into your reserved instances(RIs)"));
        ...
        for (AwsData a : lista) {
            ...
            System.out.println(a.getId_product() + ": " + m.saveData(a));
        }
    ...
    private boolean saveData(AwsData request) {
        ...
        try {
            ...
            Item item = new Item().withPrimaryKey("id_product", request.getId_product())
                    .withString("category", request.getCategory())
                    .withString("product_name", request.getProduct_name())
                    .withString("product_description", request.getProduct_description());
